...
class GDTLayer(nn.Module):
    ...
    def forward(self, graph, feat, get_attention=False):
        with graph.local_scope():
            ...
            e = (graph.edata.pop('e')/math.sqrt(self._head_dim))  # (num_src_edge, num_heads, head_dim)
            e = self.attn_activation((e * self.attn).sum(dim=-1).unsqueeze(dim=2))  # (num_edge, num_heads, 1)
            # +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
